...
const CreateHouse = ({ setShowCreateHouse , currentHouse , updateHomes , currentCity , cities  })=>{
    const [street, setStreet] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)("");
    const [zip, setZip] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)("");
    const [sq_ft, setSqft] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)("");
    const [num_of_bed, setBeds] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)("");
    const [num_of_bath, setBaths] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)("");
    const [city, setCity] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)("");
    const [year_built, setYear] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)("");
    const [lat, setLat] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)("");
    const [lng, setLng] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)("");
    ...
    const onEditHouse = async ()=>{
        ...
        try {
            const city_id = cities.find((current_city)=>current_city.city_name === city)?.city_id;
            const updated_house = {
            ...
            const response = await _services_homes_service__WEBPACK_IMPORTED_MODULE_1__/* ["default"].updateHome */ .ZP.updateHome(updated_house);
            updateHomes();
    ...
    const onCreateHouse = async ()=>{
        ...
        try {
            ...
            const returned_new_home = await _services_homes_service__WEBPACK_IMPORTED_MODULE_1__/* ["default"].createHome */ .ZP.createHome(new_house);
            updateHomes();
            setShowCreateHouse(false);
        } catch (error) {
            console.log(error);
...
const HousesComponent = ({ setShowCreateHouse , setCurrentHouse , updateHomes , cities , homes  })=>{
                            ...
                            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("table", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("tbody", {
                                        children: homes.map((home)=>/*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("tr", {
                                                children: [
...
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_components_CreateHouse__WEBPACK_IMPORTED_MODULE_3__, _services_cities_service__WEBPACK_IMPORTED_MODULE_5__, _services_homes_service__WEBPACK_IMPORTED_MODULE_6__, _components_HousesTable__WEBPACK_IMPORTED_MODULE_7__]);
([_components_CreateHouse__WEBPACK_IMPORTED_MODULE_3__, _services_cities_service__WEBPACK_IMPORTED_MODULE_5__, _services_homes_service__WEBPACK_IMPORTED_MODULE_6__, _components_HousesTable__WEBPACK_IMPORTED_MODULE_7__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);
...
async function getServerSideProps() {
    try {
        ...
        const input_homes = await _services_homes_service__WEBPACK_IMPORTED_MODULE_6__/* ["default"].getHomes */ .ZP.getHomes(city_id);
        return {
            props: {
                cities,
                input_homes
...
const HousesPage = ({ cities , input_homes  })=>{
    console.log("re-rendering page");
    const [homes, setStateHomes] = (0,react__WEBPACK_IMPORTED_MODULE_8__.useState)(input_homes);
    ...
    const [currentCity, setCurrentCity] = (0,react__WEBPACK_IMPORTED_MODULE_8__.useState)(cities[0]);
    ...
    const updateHomes = async ()=>{
        ...
        const updated_homes = await _services_homes_service__WEBPACK_IMPORTED_MODULE_6__/* ["default"].getHomes */ .ZP.getHomes(currentCity.city_id);
    ...
    const onCitySelect = async (city_id)=>{
        const selected_city = cities.find((city)=>{
            return city.city_id === parseInt(city_id);
        });
...
var __webpack_exports__ = __webpack_require__.X(0, [210,676,664,334,465,686], () => (__webpack_exec__(9887)));
