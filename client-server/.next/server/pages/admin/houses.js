...
const HousesComponent = ({ setShowCreateHouse , setCurrentHouse , setShowDeleteModal , setCurrentCity , cities , homes  })=>{
    ...
    const onCitySelect = async (city_id)=>{
        ...
        if (current_city) {
            ...
            try {
                const homes = await _services_homes_service__WEBPACK_IMPORTED_MODULE_1__/* ["default"].getHomes */ .ZP.getHomes(parseInt(city_id));
                setHomes(homes);
            } catch (e) {
                console.log(e);
                setHomes([]);
...
const HousesPage = ({ cities , input_homes  })=>{
    ...
    const updateHomes = async ()=>{
        ...
        if (currentCity) {
            ...
            const updated_homes = await _services_homes_service__WEBPACK_IMPORTED_MODULE_6__/* ["default"].getHomes */ .ZP.getHomes(cities[0].city_id);
            console.log(updated_homes);
            setStateHomes(updated_homes);
        }
    };
...
var __webpack_exports__ = __webpack_require__.X(0, [210,676,664,334,465], () => (__webpack_exec__(9887)));
